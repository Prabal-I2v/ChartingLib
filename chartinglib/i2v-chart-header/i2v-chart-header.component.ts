...
export class I2vChartHeaderComponent {
  ...
  @Output()
  combineFilterOutputEmittor: EventEmitter<ICommonFilterOutputEmittorModel> =
    new EventEmitter<ICommonFilterOutputEmittorModel>();
  ...
  //refresh Interval
  refreshInterval: CustomFilterValueModel[] = [
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (
      !alreadyDone &&
      changes.widgetCustomFiltersValue &&
      changes.widgetCustomFiltersValue.currentValue !=
        changes.widgetCustomFiltersValue.previousValue
    ) {
  ...
  private SetValueAsPerWidgetCustomFiltersValue(initialValue: boolean = false) {
    if (
      ...
      if (this.selectedCustomFilterkey in this.widgetCustomFiltersValue) {
        this.selectedCustomFilterValue = this.widgetCustomFiltersValue[
          this.selectedCustomFilterkey
        ].map((x) => {
          return String(x.returnValue);
        });
        ...
        CombineFilterOutputEmittorEmitModel["CustomFilterEmitModel"] = {
      ...
      if ("Time" in this.widgetCustomFiltersValue) {
        this.TimeFilterValue =
          this.widgetCustomFiltersValue["Time"][0].displayName;
        ...
        this.DateRange[0] = new Date(
          (<ITimeRange>(
            this.widgetCustomFiltersValue["Time"][0].returnValue
          )).startTime,
        );
        ...
        CombineFilterOutputEmittorEmitModel["DateFilterEmitModel"] = {
      ...
      if ("RefreshInterval" in this.widgetCustomFiltersValue) {
        this.refreshIntervalValue = Number(
          this.widgetCustomFiltersValue["RefreshInterval"][0].returnValue,
        );
        ...
        CombineFilterOutputEmittorEmitModel["RefreshIntervalEmitModel"] = {
          key: "RefreshInterval",
  ...
  onCustomFilterValuesChange(event) {
    ...
    this.customFilterOutput.emit(<ICustomFilterOutputEmittorModel>{
      key: this.selectedCustomFilterkey,
      value: this.selectedCustomFilterValue,
    });
  }
  ...
  onTimeChange(event) {
    ...
    if (this.timeObj != null) {
      ...
      this.widgetCustomFiltersValue["Time"] = [
        { displayName: this.TimeFilterValue, returnValue: this.timeObj },
      ];
      // console.log("Start Time : " + this.startDate + " - " + " End Time : " + this.endDate);
      this.daysFilterOutput.emit(<IDateTimeFilterOutputEmittorModel>{
        key: this.TimeFilterValue,
        value: this.timeObj,
      });
    }
  ...
  setIntervalTime(event) {
    ...
    this.refreshIntervalFilterOutput.emit(<
      ISetIntervalFilterOutputEmittorModel
    >{ key: this.TimeFilterValue, value: this.refreshIntervalValue });
